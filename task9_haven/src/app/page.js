    ...
    <div>
      <section>
        <div className="z-1 relative w-full">
          ...
          <div className="fadeInUp-animation absolute z-2 text-center top-[160px] w-full">
        ...
        <div className="fadeInUp-animation absolute z-2 top-[165%] p-2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[90%] bg-gray-50 shadow-lg rounded-xl">
        ...
        <img
          className="w-full absolute top-0 left-0 z-0 shadow-sm bg-no-repeat"
          src="/assets/home/home.png"
          alt="Description"
        />
        <div className="img-blur z-1 absolute h-[140px] bottom-[-30%] w-full bg-gradient-to-t from-pearl border-b-1"></div>
      </section>

      <section>
        <div className="mt-[120%] px-[5%]">
      ...
      <section>
        <div className="w-[90%] mt-[15%] text-white mx-[5%] flex gap-7 bg-teal-800 shadow-sm items-center rounded-3xl p-20">
          <div className="w-[50%]">
            ...
            <button className="cursor-pointer my-5 font-bold hover:bg-teal-400 transition-all duration-500 rounded-full translate-y-[-1px] hover:px-4 py-2">
              See how it works &gt;{" "}
            </button>
          </div>
          <div className="w-[50%]">
