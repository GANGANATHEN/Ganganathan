...
//           <div ref={scrollRef} style={{ overflow: "scroll", height: "100vh" }}>
//             <motion.div
...
//             transition={{ duration: 0.8, ease: "easeOut" }}
//             viewport={{ once: true }}
//             className="absolute z-2 bottom-[-120%] p-2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[90%] bg-gray-50 shadow-lg rounded-xl"
//           >
...
//               whileInView={{ opacity: 1, y: 0 }}
//               transition={{ duration: 0.8, ease: "easeOut" }}
//               viewport={{ once: true }} //dev.to/shivamkatare/create-beautiful-scroll-animations-using-framer-motion-1a7b
//               title="Servicers"
...
const ScrollCircle = () => {
  ...
  // Map scroll position to vertical movement (0 to -100 pixels)
