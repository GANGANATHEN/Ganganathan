...
export default function Home() {
  ...
  return (
    <section className="p-[180px] z-5 bg-pearl">
  ...
  Hello <span class="animate-waving-hand">👋🏻</span>, LogRocket Blog
    ...
    //       <div className="animate-[wave_5s_ease-in-out_2] z-2 text-center top-[160px] w-full">
    ...
    //       <div className="fadeInUp-animation  absolute z-2 bottom-[-120%] p-2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[90%] bg-gray-50 shadow-lg rounded-xl">
