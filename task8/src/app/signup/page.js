    ...
    <div>
      <div className="w-[40%] mx-[30%] my-[10%] rounded-md shadow-lg">
        ...
        <div className="border-y-2 border-gray-300 p-5">
          <label className="text-[15px] font-bold">Email Address</label>
          <br />
          <input
            type="email"
          ...
          <label className="text-[15px] font-bold">Retype Password</label>
          <br />
          <div className="relative">
            <input
          ...
          <button
            className="bg-blue-500 text-white rounded-md px-4 py-1 my-3 cursor-pointer"
            onClick={() => {
              handleSignup();
            }}
          >
        ...
        <h3 className="px-5 py-5 font-bold text-[15px]">
